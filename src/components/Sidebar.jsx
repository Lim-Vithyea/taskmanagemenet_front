    ...
    <div>
        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-blue-800 pt-5 ">
            <ul className="space-y-5 font-medium">
                ...
                <li>
                    <NavLink to="/dashboard/usersection" className={`${users.role === "2" ? "hidden" : "flex"} items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
